...
namespace YoutubeExtractorCore
{
    ...
    public static class DownloadUrlResolver
    {
        ...
        /// cref="GetDownloadUrlsAsync" /> method set to false.
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="YoutubeVideoNotAvailableException">The video is not available.</exception>
        ...
        public static async Task<IEnumerable<VideoInfo>> GetDownloadUrlsAsync(string videoUrl, bool decryptSignature = true)
        {
            ...
            string pageSource = await HttpHelper.DownloadStringAsync(videoUrl);
            if (IsVideoUnavailable(pageSource))
            {
                throw new YoutubeVideoNotAvailableException();
            }
            ...
            try
            {
                ...
                var infos = GetVideoInfos(downloadUrls, videoTitle).ToList();
        ...
        private static string GetStreamMap(JObject json)
        {
            ...
            {
                throw new YoutubeVideoNotAvailableException("Video is removed or has an age restriction.");
            }
        ...
        private static JObject LoadJson(string pageSource)
        {
